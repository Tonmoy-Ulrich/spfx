 ...
 */
export interface IFormCustomizerProperties {
...
export default class FormCustomizer extends BaseFormCustomizer<IFormCustomizerProperties> {
    ...
    public onInit(): Promise<void> {
        ...
        Log.info(
            LOG_SOURCE,
            "Activated FormCustomizerFormCustomizer with properties:",
        );
    ...
    public render(): void {
        ...
        const formCustomizer: React.ReactElement<{}> = React.createElement(
            CustomForm,
            {
                sp: this.sp,
